...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidCredentialsException(
        ...
        log.warn("Invalid login attempt on {}", request.getRequestURI());
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(Instant.now())
    ...
    public ResponseEntity<ErrorResponse> handleInvalidRefreshTokenException(
        ...
        log.warn("Invalid refresh token on {}: {}", request.getRequestURI(), ex.getMessage());
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(Instant.now())
                .status(HttpStatus.UNAUTHORIZED.value())
                .error(HttpStatus.UNAUTHORIZED.getReasonPhrase())
    ...
    public ResponseEntity<ErrorResponse> handleAccountDeactivatedException(
        ...
        log.warn("Login rejected: deactivated account on {}", request.getRequestURI());
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(Instant.now())
    ...
    public ResponseEntity<ErrorResponse> handleAccountNotVerifiedException(
        ...
        log.warn("Login rejected: unverified account on {}", request.getRequestURI());
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(Instant.now())
                .status(HttpStatus.FORBIDDEN.value())
                .error(HttpStatus.FORBIDDEN.getReasonPhrase())
    ...
    public ResponseEntity<ErrorResponse> handleInvalidVerificationTokenException(
        ...
        log.warn("Invalid verification token on {}: {}", request.getRequestURI(), ex.getMessage());
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(Instant.now())
                .status(HttpStatus.BAD_REQUEST.value())
                .error(HttpStatus.BAD_REQUEST.getReasonPhrase())
    ...
    public ResponseEntity<ErrorResponse> handleRoleAlreadyAssigned(
            RoleAlreadyAssignedException ex, HttpServletRequest request) {
        log.warn("Role already assigned on {}: {}", request.getRequestURI(), ex.getMessage());
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(Instant.now())
                .status(HttpStatus.CONFLICT.value())
                .error(HttpStatus.CONFLICT.getReasonPhrase())
    ...
    public ResponseEntity<ErrorResponse> handleRoleNotAssigned(
            RoleNotAssignedException ex, HttpServletRequest request) {
        log.warn("Role not assigned on {}: {}", request.getRequestURI(), ex.getMessage());
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(Instant.now())
                .status(HttpStatus.CONFLICT.value())
                .error(HttpStatus.CONFLICT.getReasonPhrase())
